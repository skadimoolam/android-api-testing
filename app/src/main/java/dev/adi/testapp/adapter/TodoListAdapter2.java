...
public class TodoListAdapter2 extends ArrayAdapter<TodoItem> {
    ...
    public TodoListAdapter2(Context context, List<TodoItem> todoItems, TodoDataSource todoData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                Toast.makeText(getContext(), tvName.getText().toString() + " is long pressed", Toast.LENGTH_SHORT).show();
                ...
                builder.setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(getContext(), etTodoName.getText().toString() + " is deleted", Toast.LENGTH_SHORT).show();
                        Toast.makeText(getContext(), etTodoGroup.getText().toString() + " is deleted", Toast.LENGTH_SHORT).show();
        ...
        cbCompleted.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cbCompleted.isChecked()) {
                    Toast.makeText(getContext(), tvName.getText().toString() + " is complete", Toast.LENGTH_SHORT).show();
                    item.setTodoCompleted(1);
                    todoData.updateTodo(item);
                } else {
                    Toast.makeText(getContext(), tvName.getText().toString() + " is incomplete", Toast.LENGTH_SHORT).show();
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getContext(), tvName.getText().toString() + " is about to be deleted", Toast.LENGTH_SHORT).show();
